...
const DraggableBodyRow = (props: RowProps) => {
    ...
    if (isSection) {
        return <tr {...props} className={`${className || ''} section-row`} />;
    }
    ...
    const style: React.CSSProperties = {
        ...
        transition,
        background: isDragging ? 'linear-gradient(135deg, #e6f7ff, #bae0ff) !important' : undefined,
...
export default React.memo(CarouselLibPage2);